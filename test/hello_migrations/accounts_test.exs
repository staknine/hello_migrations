defmodule HelloMigrations.AccountsTest do
  use HelloMigrations.DataCase

  alias HelloMigrations.Accounts

  describe "users" do
    alias HelloMigrations.Accounts.User

    import HelloMigrations.AccountsFixtures
